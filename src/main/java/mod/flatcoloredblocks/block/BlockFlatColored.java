...
public class BlockFlatColored extends Block {
    ...
    protected BlockFlatColored(
        ...
        super(Block.Properties.create(opacity > 0.001 ? Material.GLASS : Material.ROCK)
                ...
                .setLightLevel((s) -> (int) (FlatColoredBlocks.instance.config.GLOWING_EMITS_LIGHT ? Math.max(0, Math.min(15, 15.0f * (lightValue / 255.0f))) : 0))
...
*/
    ...
    public MaterialColor getMaterialColor() {
        for (final EnumFlatColorAttributes attr : getFlatColorAttributes(getDefaultState())) {
            if (!attr.isModifier) {
                return attr.mapColor;
            }
        }
    ...
    public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
        ...
        drops.add(getItem(null, null, state));
        return drops;
